...
- Создайте проект Vue с помощью create-vite: `npm init --yes vue@latest auditsystem.client -- --eslint  --typescript `.
...
- Создание файла проекта (`auditsystem.client.esproj`).
